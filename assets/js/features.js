    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">FiN</span> <span class="clr-green">Food In an Instant</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
var bestDishes = [
    {
        ...
        rating: 4,
        imgURL: "assets/images/sandwitch1.webp",
    ...
    },
    {
        title: 'Samosa',
        rating: 5,
        imgURL: "assets/images/samosa.jpeg",
        description: "Sumptuous delicious food baked in our cafe with curated ingredients",
        price: 10
    },
    {
    ...
    },
    {
        title: 'Maggie',
        rating: 4,
        imgURL: "assets/images/maggie-lnct.jpeg",
        description: "Sumptuous delicious food baked in our cafe with curated ingredients",
        price: 40
    }
]
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">LNCT</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>Today, LNCT Group is one of the Largest and most preferred Educational Group for Engineering, Management, Pharmacy, Medical with ISO-9001 certification and NBA accreditation for many Engineering courses.. Bright young students from all across the country are coming to fulfill their dream in this group.
                        </p>
                        <ul class="py-1">

                            <li><i class="fab fa-twitter"></i><a href="https://www.instagram.com/malwa_institute_of_technology/" target="_blank">Twitter</a></li>
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://lnct.ac.in/" target="_blank">LNCT Bhopal</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>0755-6185300,0755-6185300/1/2/3/4/5</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>admission@lnctbhopal.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>LNCT CAMPUS, Raisen Road, Bhopal (MP)-462023</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.lnct.ac.in</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Digital Troops</a></div>
                </main>
            </section>
        `;
        })
                ...
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <ul class="py-1">
                            ...
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/lnctgroupofcolleges/" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
    ...
    .on('value', function(snapshot){
        if (snapshot.exists()){
            ...
            userOrder.forEach(key => {
                ...
                var trimedID = '';
                var oid = 0;
                var orderID = 'UO' + time + i

                // Creates Order ID
                for (let j = 0; j < orderID.length; j++){
                    if (orderID[j] != ':' && orderID[j] != 'p' && orderID[j] != 'm' && orderID[j] != 'P' && orderID[j] != 'M' && orderID[j] != 'a' && orderID[j] != 'A' && orderID[j] != ' ' ){
                        trimedID += orderID[j]
